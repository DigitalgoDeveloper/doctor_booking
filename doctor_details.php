            ...
            <div class="page">
                <div class="popup-page-header">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <h3 id="popup-page-title" class="text-center">
                                <?php echo $branches[$_GET['branch']]['doctors'][$_GET['doctor']]['name'] ?>
                            </h3>
                        </div>
                        <div class="col-2"></div>
                    </div>
                ...
                <div id="popup-page-content" class="my-3">
                    <div class="d-flex flex-column product-details w-75 m-auto" data-worker-id="37" data-worker-status="0">
                        <div class="d-flex justify-content-center">
                            <label class=" bg-light-gray rounded px-2">
                                <h4>
                                    <?php echo $branches[$_GET['branch']]['name'] ?>
                        ...
                        <div class="d-flex w-100 position-relative mb-3">
                            <img src="<?php echo $branches[$_GET['branch']]['doctors'][$_GET['doctor']]['image'] ?>" alt="" class="rounded 2 mt-3 m-auto" style="">
                        ...
                        <div class="product-info mt-2 ">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="flex-column d-flex">
                                    <div class="d-flex my-1">
                                        ...
                                        <span>
                                            <?php echo $branches[$_GET['branch']]['doctors'][$_GET['doctor']]['nationality'] ?>


                                        </span>
                                    </div>
                                    <div class="d-flex my-1">
                                        <label class="me-2">الفرع: </label>
                                        <span>
                                            <?php echo $branches[$_GET['branch']]['name'] ?>
                                    ...
                                    <div class="d-flex my-1">
                                        <label class="me-2">التخصص: </label>
                                        <span>
                                            <?php echo $branches[$_GET['branch']]['doctors'][$_GET['doctor']]['speciality'] ?>
                                        </span>
                                    </div>
                            ...
                            <div class="mt-2 text-center">
                                <a href="">
                                    <img src="./assets/svg/contact-snapchat.svg" class="icon">
                                </a>
                                <a href="">
                                    <img src="./assets/svg/contact-Instagram-main-color.svg" class="icon">
                                </a>
                            </div>
                            <?php if ($branches[$_GET['branch']]['doctors'][$_GET['doctor']]['status'] == 'متاح') : ?>
                                <div class="mt-2">
