    ...
    <div class="popup-page-wrap" style="height: 0px; min-height: initial;">
        <div class="page-overlay">
            <div class="page">
                <div class="popup-page-header">
                    <div class="row">
                        <div class="col-2">
                            <div class="close icon"><img src="./assets/svg/close-outline.svg" alt="">
                            </div>
                        </div>
                        <div class="col-8">
                            <h3 id="popup-page-title" class="text-center">test</h3>
                        </div>
                        <div class="col-2"></div>
                    </div>
                </div>
                <div id="popup-page-content" class="my-3">
                    <div class="d-flex flex-column product-details w-75 m-auto" data-worker-id="38" data-worker-status="0">
                        <div class="d-flex justify-content-center">
                            <label class=" bg-light-gray rounded px-2">
                                <h4>راية الاعمال للاستقدام
                                </h4>
                            </label>
                            <div>
                            </div>
                        ...
                        <div class="product-info mt-2 ">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3 for="">الخبرات: </h3>
                                    <div>
                                        <img src="./assets/svg/checkbox-outline.svg" class="icon me-1">
                                        اللغات:
                                        الانجليزية
                                    </div>
                                ...
                                <div class="flex-column d-flex">
                                    ...
                                    <div class="d-flex my-1">
                                        <label class="me-2">المدينة: </label>
                                        <span>
                                            بقيق
                                        </span>
                                    </div>
                            ...
                            <div class="mt-4">
                                <button class="color3 btn btn-success w-100 saned-button" data-saned-url="">
                                    اخبرني عند التوفر
                                </button>
                            </div>
